...
public class HorseInfo extends HudElement {
    public static final HudElementInfo<HorseInfo> INFO = new HudElementInfo<>(
        AddonTemplate.HUD_GROUP, "HorseInfo", "Displays horse stats while riding.", HorseInfo::new
    );
    ...
    public void render(HudRenderer renderer) {
        ...
        double jumpBlocks = -0.1817584952 * Math.pow(jump, 3)
